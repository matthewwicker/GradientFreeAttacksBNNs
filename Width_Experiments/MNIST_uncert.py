...
for w in widths:
    model = PosteriorModel("%s_FCN_Posterior_%s"%(inference, w))
    ...
    print("AUC: ", auc)
    print("-------------------------------")
    MNIST_Uncertainty.append((np.mean(epistemic), np.mean(aleatoric), auc))
    ...
    print("AUC: ", auc)
    print("-------------------------------")
    llr, o, i = analyzers.likelihood_ratio(model, X_test[0:num_images], F_train[0:num_images])
    print("LLR: ", llr, o)
    print("-------------------------------")
    Fashion_Uncertainty.append((np.mean(epistemic), np.mean(aleatoric), auc))
    fash_llr.append((llr, o, i))
    ...
    print("AUC: ", auc)
    print("-------------------------------")
    llr, o, i = analyzers.likelihood_ratio(model, X_test[0:num_images], adv, labels=y_test[0:num_images])
    print("LLR: ", llr, o)
    print("-------------------------------")
    Adv_Uncertainty.append((np.mean(epistemic), np.mean(aleatoric), auc))
    adv_llr.append((llr, o, i))

print(MNIST_Uncertainty)
print(Fashion_Uncertainty)
print(Adv_Uncertainty)
print(fash_llr)
print(adv_llr)
